...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title inertia>OMMC Henri Performance Monitoring</title>
                ...
                <div class="{{ $fullWidth ? '' : 'container' }} py-3 sm:py-5 mx-auto border-b border-gray-200 dark:border-gray-900">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 text-lg sm:text-2xl text-gray-700 dark:text-gray-300 font-medium"><b class="font-bold">OMMC Henri</b> Performance Monitoring</span>
                        </div>
                        <div class="flex items-center gap-3 sm:gap-6">
                            <a href="/app/salescall-page"
